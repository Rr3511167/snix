...
import (
	...
	wbe "github.com/SamNet-dev/snix/platform/windows"
)

// stdoutLogger adapts io.Writer to engine.Logger.
...
// runEngine opens the WinDivert backend, starts the bypass engine, and runs
// the pass-through TCP relay on profile.Listen. Requires Administrator +
// WinDivert.dll/WinDivert64.sys available (next to snix.exe or on PATH).
